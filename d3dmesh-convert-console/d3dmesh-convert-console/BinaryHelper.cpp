...
unsigned int BinaryHelper::BitFieldExtract(unsigned int data, unsigned int offset, unsigned int numBits)
{
...
//unsigned int BinaryHelper::BitFieldInsert(unsigned int mask, unsigned int src, unsigned int dst)
//{
	//return (src & mask) | (dst & ~mask);
//}

// Inserts the bits indicated by 'mask' from 'src' into 'dst'.
unsigned int BinaryHelper::BitFieldInsert(unsigned int numBits, unsigned int src, unsigned int dst)
{
	unsigned int mask = (1u << numBits) - 1u;
	return (src & mask) | (dst & ~mask);
}
...
unsigned int BinaryHelper::as_uint(const float x)
{
	return *(unsigned int*)&x;
}
float BinaryHelper::as_float(const unsigned int  x)
{
	return *(float*)&x;
}

// IEEE-754 16-bit floating-point format (without infinity): 1-5-10, exp-15, +-131008.0, +-6.1035156E-5, +-5.9604645E-8, 3.311 digits
float BinaryHelper::half_to_float(const unsigned short x)
{
...
// IEEE-754 16-bit floating-point format (without infinity): 1-5-10, exp-15, +-131008.0, +-6.1035156E-5, +-5.9604645E-8, 3.311 digits
unsigned short BinaryHelper::float_to_half(const float x)
{
