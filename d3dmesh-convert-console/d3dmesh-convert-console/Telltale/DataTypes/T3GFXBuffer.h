...
#include "../../Telltale/Enums/T3ResourceUsage.h"
#include "../../Telltale/Enums/GFXPlatformBufferUsage.h"
...
struct T3GFXBuffer
{
	...
	T3GFXBuffer()
	{
		mResourceUsage = T3ResourceUsage::eResourceUsage_Static;
		mBufferFormat = GFXPlatformFormat::eGFXPlatformFormat_None;
		mBufferUsage = GFXPlatformBufferUsage::eGFXPlatformBuffer_None;
		mCount = 0;
		mStride = 0;
	};
	...
	{
		mResourceUsage = (T3ResourceUsage)ReadInt32FromBinary(inputFileStream); //[4 BYTES]
		mBufferFormat = (GFXPlatformFormat)ReadInt32FromBinary(inputFileStream); //[4 BYTES]
		mBufferUsage = (GFXPlatformBufferUsage)ReadUInt32FromBinary(inputFileStream); //[4 BYTES]
	...
	{
		//begin serialization
		WriteInt32ToBinary(outputFileStream, mResourceUsage); //[4 BYTES]
		WriteInt32ToBinary(outputFileStream, mBufferFormat); //[4 BYTES]
		WriteUInt32ToBinary(outputFileStream, static_cast<unsigned int>(mBufferUsage)); //[4 BYTES]
	...
	std::string ToString() const
	{
		...
		output += "[T3GFXBuffer] mBufferUsage: " + std::to_string(static_cast<unsigned int>(mBufferUsage)) + "\n";
