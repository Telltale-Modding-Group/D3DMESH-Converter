...
public:
	...
	/// [4 BYTES] mFlags
	/// </summary>
	T3MeshBatchUsageFlag mBatchUsage;
	...
	T3MeshBatch()
	{
		mBoundingBox = {};
		mBoundingSphere = {};
		mBatchUsage = (T3MeshBatchUsageFlag)0;
		mMinVertIndex = 0;
		mMaxVertIndex = 0;
		mBaseIndex = 0;
		mStartIndex = 0;
		mNumPrimitives = 0;
		mNumIndices = 0;
		mTextureIndices_BlockSize = 8;
		mTextureIndices = {};
		mTextureIndices_End = -1;
		mMaterialIndex = 0;
	...
	T3MeshBatch(std::ifstream* inputFileStream)
	{
		...
		mBatchUsage = (T3MeshBatchUsageFlag)ReadUInt32FromBinary(inputFileStream); //[4 BYTES]
	...
	void BinarySerialize(std::ofstream* outputFileStream)
	{
		...
		WriteUInt32ToBinary(outputFileStream, static_cast<unsigned int>(mBatchUsage)); //[4 BYTES]
	...
	std::string ToString() const
	{
		...
		output += "[T3MeshBatch] mBatchUsage: " + std::to_string(static_cast<unsigned int>(mBatchUsage)) + "\n";
