#pragma once
#ifndef APPLICATION_READ_D3DMESH_EXPORT_ASSIMP_H
#define APPLICATION_READ_D3DMESH_EXPORT_ASSIMP_H
...
void Application_ReadD3DMesh_ExportAssimp()
{
	std::cout << "Starting... READ D3DMESH / EXPORT ASSIMP " << std::endl;
	...
	std::cout << "Finished... READ D3DMESH / EXPORT ASSIMP " << std::endl;
}
