#pragma once
#ifndef APPLICATION_READ_D3DMESH_AND_SKELETON_H
#define APPLICATION_READ_D3DMESH_AND_SKELETON_H
...
void Application_ReadD3DMeshAndSkeleton()
{
	std::cout << "Starting... READ D3DMESH AND SKELETON " << std::endl;
